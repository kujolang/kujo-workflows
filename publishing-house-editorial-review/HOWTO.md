# How to operate Publishing House Editorial Review and Revision
...
```bash
(cd publishing-house-editorial-review && KUJO_MODULE_PATH=.. KUJO_BIN=../kujo/target/release/kujo ../kujo/target/release/kujo run workflow.kujo -- --request fixtures/request.fixture.json --json)
```
