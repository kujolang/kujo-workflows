...
Primary roles: Production Editor, Publishing Operations Director. Required tools: galleypack, versionseal, presswire, storydesk, dispatch, agents-sdk. Default permission: PROPOSE. Readiness: Limited technical preview; fixture evidence is verified locally, while live adapters and live-provider execution remain environment-specific.
