# How to operate Publishing House Primary Piece Production
...
```bash
(cd publishing-house-primary-piece && KUJO_MODULE_PATH=.. KUJO_BIN=../kujo/target/release/kujo ../kujo/target/release/kujo run workflow.kujo -- --request fixtures/request.fixture.json --json)
```
