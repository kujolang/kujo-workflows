# How to operate Publishing House Commissioning
...
```bash
(cd publishing-house-commissioning && KUJO_MODULE_PATH=.. KUJO_BIN=../kujo/target/release/kujo ../kujo/target/release/kujo run workflow.kujo -- --request fixtures/request.fixture.json --json)
```
