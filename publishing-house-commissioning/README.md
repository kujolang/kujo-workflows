...
Turn an approved idea or signal into a specific Editorial Brief, assignments, and an evidence work order.

## Boundary

Commissioning records a proposal and approval owner; it does not approve publication. Record ownership remains with storydesk, dossier; this workflow stores references and orchestration receipts only.

## Run the deterministic fixture

```bash
(cd publishing-house-commissioning && bash bin/run --request fixtures/request.fixture.json --json)
```
...
Primary roles: Commissioning Editor, Editorial Strategy Director, Creative Director, Brand Strategy Director. Required tools: storydesk, dossier, dispatch, agents-sdk. Default permission: PROPOSE. Readiness: Limited technical preview; fixture evidence is verified locally, while live adapters and live-provider execution remain environment-specific.
