...
Primary roles: Commissioning Editor, Editorial Strategy Director, Creative Director, Brand Strategy Director. Required tools: storydesk, dossier, dispatch, agents-sdk. Default permission: PROPOSE. Readiness: installable and verified for the locked offline fixture contract; catalog status remains Limited because operator-specific live adapters are not included.
