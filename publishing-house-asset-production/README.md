...
Primary roles: Art Director, Video & Audio Producer, Production Editor. Required tools: assetworks, dossier, galleypack, dispatch, agents-sdk. Default permission: PROPOSE. Readiness: installable and verified for the locked offline fixture contract; catalog status remains Limited because operator-specific live adapters are not included.
