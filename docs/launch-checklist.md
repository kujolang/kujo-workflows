...
Hosted runner deployment, live-provider workflows, marketplace publication, live credentials, branch-protection changes, and force-pushes remain out of scope. Public releases and final tags require explicit maintainer authorization; this change does not create a `v0.6.0` tag.
