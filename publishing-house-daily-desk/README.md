...
Primary roles: Managing Editor, Commissioning Editor, Production Editor. Required tools: storydesk, dispatch, agents-sdk. Default permission: PROPOSE. Readiness: installable and verified for the locked offline fixture contract; catalog status remains Limited because operator-specific live adapters are not included.
