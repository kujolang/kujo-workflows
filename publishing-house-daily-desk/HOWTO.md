# How to operate Publishing House Daily Desk
...
```bash
(cd publishing-house-daily-desk && KUJO_MODULE_PATH=.. KUJO_BIN=../kujo/target/release/kujo ../kujo/target/release/kujo run workflow.kujo -- --request fixtures/request.fixture.json --json)
```
