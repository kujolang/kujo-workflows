# How to operate Publishing House Post-Publication Learning
...
```bash
(cd publishing-house-post-publication && KUJO_MODULE_PATH=.. KUJO_BIN=../kujo/target/release/kujo ../kujo/target/release/kujo run workflow.kujo -- --request fixtures/request.fixture.json --json)
```
