# How to operate Publishing House Evidence Dossier
...
```bash
(cd publishing-house-evidence-dossier && KUJO_MODULE_PATH=.. KUJO_BIN=../kujo/target/release/kujo ../kujo/target/release/kujo run workflow.kujo -- --request fixtures/request.fixture.json --json)
```
